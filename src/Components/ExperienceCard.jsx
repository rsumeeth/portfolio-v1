    ...
    <Box sx={largeTile}>
      ...
      <div>
        ...
        <div style={{ color: "#94A3B8", marginBottom: "10px" }}>
          ...
          SPA to support complex Banking Web Application using React Js, Redux
          Toolkit.
        </div>
        <div style={{ color: "#94A3B8", marginBottom: "10px" }}>
        ...
        <div style={{ color: "#94A3B8", marginBottom: "10px" }}>
          Worked on Jest and react testing library in testing and performed Unit
          testing with 80% minimum code coverage.
        </div>
